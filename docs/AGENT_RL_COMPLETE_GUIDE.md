# Agent RL 全链路教程：从工具选择、多轮对话到 Reward、Advantage 与 Token Loss
...
![Agent RL 学习地图](assets/agent_rl_learning_map.svg)
...
![训练与推理阶段的工具选择](assets/agent_rl_tool_selection.svg)
...
![单条样例从 JSON 到 Loss 的完整数据流](assets/agent_rl_end_to_end_trace.svg)
...
![Token 区域与损失 Mask](assets/agent_rl_token_mask.svg)
...
![四条 Rollout 从 Reward 到 Loss](assets/agent_rl_reward_to_loss.svg)
